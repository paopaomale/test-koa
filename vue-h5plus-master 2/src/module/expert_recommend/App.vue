  ...
  <div id="expert_recommend_page">
    <div class="nav">
      <header class="mint-header">
          ...
          <h1 class="mint-header-title">专家作者</h1> 
      </header>
    </div>
         ...
         <div class="recommend-li" v-for="(item,index) in activeList">
           ...
           <div class="recommend-li-center">
             <div class="RLC-top">
               ...
               <div class="RLC-top-author">专家专栏</div>
             </div>
             <div class="RLC-center">{{item.career}}</div>
             <div class="RLC-bottom">{{item.introduce}}</div>
           </div>
           <div class="recommend-li-right">
            <div v-if="item.isSub == 'false'" @click.stop="onAuthorLiSub(item,false)">+订阅</div>
            <div v-else @click.stop="onAuthorLiSub(item,true)">已订阅</div>
           </div>
         </div>
       </div>
      </vue-better-scroll>
